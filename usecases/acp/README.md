...
⚠️ **Saída tóxica (HAP):** A aplicação pode gerar conteúdo odioso, abusivo ou inapropriado. O filtro HAP da IBM utiliza IA para prevenir esse tipo de saída.
...
🧩 **Proliferação de agentes:** Desafio de gerenciar e governar um grande número de agentes dentro de uma organização.

✅ **Avaliação de qualidade:** é uma boa prática medir a qualidade das saídas de um sistema de IA antes de colocá-lo em produção.
...
🛠️ Debugging: análise e investigação de problemas quando o sistema não se comporta como esperado.
...
### 4. [**Vazamento de PII**](controls/README.md) 
